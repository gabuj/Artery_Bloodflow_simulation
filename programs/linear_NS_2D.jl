...
#discrete model
# model=GmshDiscreteModel("models/cylinder_light.msh")
...
neumann((v,q))=  ∫( (v·n_Γ_i) * p_inlet )*dΓ_i + ∫( (v·n_Γ_o) * p_out )*dΓ_o #- ∫( v·(∇(u)·n_Γ_i))dΓ_i - ∫( v·(∇(u)·n_Γ_o))dΓ_o


################

op = AffineFEOperator(a,neumann,X,Y)
...
# Write to VTK
outputfile = "tutorial_outputs/exploring_neumann_boundaries/linear_NS_2D"
